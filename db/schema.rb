...
ActiveRecord::Schema.define(version: 2016_02_24_183028) do
  ...
  create_table "cache_ports", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title", limit: 100
    t.bigint "mac_address", unsigned: true
    t.integer "cache_switch_id", null: false
    t.index ["cache_switch_id"], name: "fk_cache_ports_cache_switches1_idx"
  end
  ...
  create_table "container_slots", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title", limit: 100
  ...
  create_table "containers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title", limit: 100
  ...
  create_table "device_brands", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title", limit: 100, null: false
  end
  ...
  create_table "device_types", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title", limit: 100, null: false
  ...
  create_table "params", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title", limit: 100, null: false
    t.string "unit", limit: 100, null: false
  end

  create_table "places", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title", limit: 100, null: false
  end
  ...
  create_table "stock_items", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["container_id"], name: "fk_stock_item_containers1_idx"
    t.index ["device_model_id"], name: "fk_stock_item_device_models1_idx"
  ...
  create_table "stock_param_values", id: :integer, default: nil, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "device_model_param_id", null: false
    t.index ["device_model_param_id"], name: "fk_stock_param_value_device_model_param1_idx"
