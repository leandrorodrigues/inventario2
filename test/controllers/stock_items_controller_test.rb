...
class StockItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stock_item" do
    assert_difference('StockItem.count') do
      post stock_items_url, params: { stock_item: { is_package: @stock_item.is_package, item_id: @stock_item.item_id, package_quantity: @stock_item.package_quantity, quantity: @stock_item.quantity, title: @stock_item.title } }
    end
  ...
  test "should update stock_item" do
    patch stock_item_url(@stock_item), params: { stock_item: { is_package: @stock_item.is_package, item_id: @stock_item.item_id, package_quantity: @stock_item.package_quantity, quantity: @stock_item.quantity, title: @stock_item.title } }
